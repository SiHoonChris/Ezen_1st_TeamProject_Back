...
<div class="container">
	...
	<form class="form-horizontal" id="frm">
		<div class="form-group">
			<div>
				<h2 class="adminTitle">공지사항 관리</h2>
			</div>
		</div>
		...
		<select class="form-select" style="width:200px; margin-right:10px;" aria-label="Default select example" title="카테고리 선택" id="n_bc_code" name="n_bc_code" >
